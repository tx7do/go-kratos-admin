...
require (
	...
	github.com/tx7do/kratos-transport/transport/asynq v1.2.32
	github.com/tx7do/kratos-transport/transport/sse v1.2.23
...
require (
	...
	github.com/tx7do/kratos-transport/transport/keepalive v1.0.5 // indirect
