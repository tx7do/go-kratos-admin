...
VALUES (1, null, 'FOLDER', 'Dashboard', '/', null, 'BasicLayout', 'ON', now(),
       ...
       (10, null, 'FOLDER', 'Auth', '/auth', null, 'BasicLayout', 'ON', now(),
        '{"order":2000, "title":"menu.auth.moduleName", "icon":"lucide:shield-check", "keepAlive":true, "hideInBreadcrumb":false, "hideInMenu":false, "hideInTab":false}'),
       (11, 10, 'MENU', 'UserManagement', 'users', null, 'app/auth/users/index.vue', 'ON', now(),
        '{"order":1, "title":"menu.auth.user", "icon":"lucide:users", "keepAlive":false, "hideInBreadcrumb":false, "hideInMenu":false, "hideInTab":false}'),
       (12, 10, 'MENU', 'UserDetail', 'users/detail/:id', null, 'app/auth/users/detail/index.vue', 'ON', now(),
        '{"order":2, "title":"menu.auth.userDetail", "icon":"", "keepAlive":false, "hideInBreadcrumb":false, "hideInMenu":true, "hideInTab":false}'),
       (13, 10, 'MENU', 'TenantManagement', 'tenants', null, 'app/auth/tenants/index.vue', 'ON', now(),
        '{"order":3, "title":"menu.auth.tenant", "icon":"lucide:book-user", "keepAlive":false, "hideInBreadcrumb":false, "hideInMenu":false, "hideInTab":false}'),
       (14, 10, 'MENU', 'RoleManagement', 'roles', null, 'app/auth/role/index.vue', 'ON', now(),
        '{"order":4, "title":"menu.auth.role", "icon":"lucide:chef-hat", "keepAlive":false, "hideInBreadcrumb":false, "hideInMenu":false, "hideInTab":false}'),
       (15, 10, 'MENU', 'OrganizationManagement', 'organizations', null, 'app/auth/org/index.vue', 'ON', now(),
        '{"order":5, "title":"menu.auth.org", "icon":"lucide:building-2", "keepAlive":false, "hideInBreadcrumb":false, "hideInMenu":false, "hideInTab":false}'),
       (16, 10, 'MENU', 'DepartmentManagement', 'departments', null, 'app/auth/dept/index.vue', 'ON', now(),
        '{"order":6, "title":"menu.auth.dept", "icon":"lucide:network", "keepAlive":false, "hideInBreadcrumb":false, "hideInMenu":false, "hideInTab":false}'),
       (17, 10, 'MENU', 'PositionManagement', 'positions', null, 'app/auth/position/index.vue', 'ON', now(),
        '{"order":7, "title":"menu.auth.position", "icon":"lucide:id-card", "keepAlive":false, "hideInBreadcrumb":false, "hideInMenu":false, "hideInTab":false}'),
       (18, 10, 'MENU', 'MenuManagement', 'menus', null, 'app/auth/menu/index.vue', 'ON', now(),
        '{"order":8, "title":"menu.auth.menu", "icon":"lucide:square-menu", "keepAlive":false, "hideInBreadcrumb":false, "hideInMenu":false, "hideInTab":false}'),

       (20, null, 'FOLDER', 'System', '/system', null, 'BasicLayout', 'ON', now(),
        '{"order":2001, "title":"menu.system.moduleName", "icon":"lucide:settings", "keepAlive":true, "hideInBreadcrumb":false, "hideInMenu":false, "hideInTab":false}'),
       (21, 20, 'MENU', 'DictManagement', 'dict', null, 'app/system/dict/index.vue', 'ON', now(),
       ...
       (22, 20, 'MENU', 'FileManagement', 'files', null, 'app/system/files/index.vue', 'ON', now(),
        '{"order":2, "title":"menu.system.file", "icon":"lucide:file", "keepAlive":false, "hideInBreadcrumb":false, "hideInMenu":false, "hideInTab":false}'),
       (23, 20, 'MENU', 'TaskManagement', 'tasks', null, 'app/system/task/index.vue', 'ON', now(),
       ...
       (24, 20, 'MENU', 'APIResourceManagement', 'apis', null, 'app/system/api_resource/index.vue', 'ON', now(),
       ...
       (25, 20, 'MENU', 'NotificationMessageManagement', 'notifications', null,
       ...
       (26, 20, 'MENU', 'NotificationMessageCategoryManagement', 'notification_categories', null,
       ...
       (27, 20, 'MENU', 'PrivateMessageManagement', 'private_messages', null, 'app/system/private_message/index.vue',
        'ON', now(),
       ...
       (30, null, 'FOLDER', 'Log', '/log', null, 'BasicLayout', 'ON', now(),
       ...
       (31, 30, 'MENU', 'AdminLoginLog', 'login', null, 'app/log/admin_login_log/index.vue', 'ON', now(),
        '{"order":1, "title":"menu.log.adminLoginLog", "icon":"lucide:log-in", "keepAlive":false, "hideInBreadcrumb":false, "hideInMenu":false, "hideInTab":false}'),
       (32, 30, 'MENU', 'AdminOperationLog', 'operation', null, 'app/log/admin_operation_log/index.vue', 'ON', now(),
        '{"order":2, "title":"menu.log.adminOperationLog", "icon":"lucide:arrow-up-down", "keepAlive":false, "hideInBreadcrumb":false, "hideInMenu":false, "hideInTab":false}');
