...
type Organization struct {
	...
	SortOrder        *int32                 `protobuf:"varint,10,opt,name=sort_order,json=sortOrder,proto3,oneof" json:"sort_order,omitempty"`                                                            // 排序顺序，值越小越靠前
...
func (x *Organization) GetCreatedBy() uint32 {
...
func (x *Organization) GetUpdatedBy() uint32 {
...
func (x *Organization) GetDeletedBy() uint32 {
...
func (x *ListOrganizationResponse) GetTotal() uint64 {
	if x != nil {
		return x.Total
	}
	return 0
...
type GetOrganizationRequest struct {
	...
	QueryBy       isGetOrganizationRequest_QueryBy `protobuf_oneof:"query_by"`
...
func (x *GetOrganizationRequest) GetQueryBy() isGetOrganizationRequest_QueryBy {
	if x != nil {
		return x.QueryBy
	}
	return nil
...
func (x *GetOrganizationRequest) GetId() uint32 {
	if x != nil {
		if x, ok := x.QueryBy.(*GetOrganizationRequest_Id); ok {
			return x.Id
		}
	}
	return 0
...
type isGetOrganizationRequest_QueryBy interface {
	isGetOrganizationRequest_QueryBy()
}
...
func (*GetOrganizationRequest_Id) isGetOrganizationRequest_QueryBy() {}
...
type BatchCreateOrganizationsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	CreatedIds    []int32                `protobuf:"varint,1,rep,packed,name=created_ids,json=createdIds,proto3" json:"created_ids,omitempty"` // 创建成功的组织ID列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BatchCreateOrganizationsResponse) GetCreatedIds() []int32 {
	if x != nil {
		return x.CreatedIds
	}
	return nil
...
const file_user_service_v1_organization_proto_rawDesc = "" +
	"\n" +
	"\"user/service/v1/organization.proto\x12\x0fuser.service.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a google/protobuf/field_mask.proto\x1a\x1epagination/v1/pagination.proto\"\xfc\x0e\n" +
	"\fOrganization\x12#\n" +
	...
	"\aaddress\x18\a \x01(\tB\x12\xbaG\x0f\x92\x02\f注册地址H\x06R\aaddress\x88\x01\x01\x12K\n" +
	"\n" +
	"sort_order\x18\n" +
	" \x01(\x05B'\xbaG$\x92\x02!排序顺序，值越小越靠前H\aR\tsortOrder\x88\x01\x01\x12O\n" +
	...
	"\bchildren\x183 \x03(\v2\x1d.user.service.v1.OrganizationB\x12\xbaG\x0f\x92\x02\f子节点树R\bchildren\x125\n" +
	"\n" +
	...
	"\n" +
	"deleted_at\x18\xca\x01 \x01(\v2\x1a.google.protobuf.TimestampB\x12\xbaG\x0f\x92\x02\f删除时间H\x13R\tdeletedAt\x88\x01\x01\"_\n" +
	"\x04Type\x12!\n" +
	...
	"\x16GetOrganizationRequest\x12\x1c\n" +
	...
	"\x04data\x18\x01 \x01(\v2\x1d.user.service.v1.OrganizationR\x04data\"\x9c\x03\n" +
	"\x19UpdateOrganizationRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\x121\n" +
	"\x04data\x18\x02 \x01(\v2\x1d.user.service.v1.OrganizationR\x04data\x12s\n" +
	...
	"\x04data\x18\x01 \x03(\v2\x1d.user.service.v1.OrganizationR\x04data\"h\n" +
	" BatchCreateOrganizationsResponse\x12D\n" +
	"\vcreated_ids\x18\x01 \x03(\x05B#\xbaG \x92\x02\x1d创建成功的组织ID列表R\n" +
	"createdIds2\x9c\x04\n" +
...
var file_user_service_v1_organization_proto_depIdxs = []int32{
	...
	10, // 3: user.service.v1.Organization.created_at:type_name -> google.protobuf.Timestamp
