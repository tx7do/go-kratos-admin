...
func (tq *TaskQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (tq *TaskQuery) FirstIDX(ctx context.Context) uint32 {
...
func (tq *TaskQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (tq *TaskQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (tq *TaskQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (tq *TaskQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := tq.IDs(ctx)
	if err != nil {
		panic(err)
	}
