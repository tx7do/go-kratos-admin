...
func initApp(logger log.Logger, registrar registry.Registrar, bootstrap *v1.Bootstrap) (*kratos.App, func(), error) {
	...
	userService := service.NewUserService(logger, userRepo, roleRepo, userCredentialRepo, positionRepo, departmentRepo, organizationRepo)
	...
	roleService := service.NewRoleService(logger, roleRepo, authorizer)
