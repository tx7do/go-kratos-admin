...
func (*UserPosition) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case userposition.FieldID, userposition.FieldCreatedBy, userposition.FieldUpdatedBy, userposition.FieldDeletedBy, userposition.FieldUserID, userposition.FieldPositionID:
			values[i] = new(sql.NullInt64)
		case userposition.FieldCreatedAt, userposition.FieldUpdatedAt, userposition.FieldDeletedAt:
