...
export enum AdminLoginRestrictionType {
  ...
  /** LOGIN_RESTRICTION_TYPE_BLACKLIST - 黑名单 */
  LOGIN_RESTRICTION_TYPE_BLACKLIST = "LOGIN_RESTRICTION_TYPE_BLACKLIST",
  /** LOGIN_RESTRICTION_TYPE_WHITELIST - 白名单 */
  LOGIN_RESTRICTION_TYPE_WHITELIST = "LOGIN_RESTRICTION_TYPE_WHITELIST",
}
...
export enum AdminLoginRestrictionMethod {
  ...
  /** LOGIN_RESTRICTION_METHOD_IP - IP地址限制 */
  LOGIN_RESTRICTION_METHOD_IP = "LOGIN_RESTRICTION_METHOD_IP",
  /** LOGIN_RESTRICTION_METHOD_MAC - MAC地址限制，绑定设备的MAC地址。 */
  LOGIN_RESTRICTION_METHOD_MAC = "LOGIN_RESTRICTION_METHOD_MAC",
  /** LOGIN_RESTRICTION_METHOD_REGION - 地区限制，根据地理位置（如国家、城市）限制登录。 */
  LOGIN_RESTRICTION_METHOD_REGION = "LOGIN_RESTRICTION_METHOD_REGION",
  /** LOGIN_RESTRICTION_METHOD_TIME - 时间限制，限制登录的时间段，例如只允许工作时间登录。 */
  LOGIN_RESTRICTION_METHOD_TIME = "LOGIN_RESTRICTION_METHOD_TIME",
  /** LOGIN_RESTRICTION_METHOD_DEVICE - 设备限制，限制登录设备的类型（如PC、手机）或特定设备ID。 */
  LOGIN_RESTRICTION_METHOD_DEVICE = "LOGIN_RESTRICTION_METHOD_DEVICE",
}
