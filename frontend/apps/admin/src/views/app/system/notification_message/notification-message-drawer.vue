...
import { statusList, useNotificationMessageStore } from '#/store';
  ...
  async onConfirm() {
    ...
    try {
      await (data.value?.create
        ? notificationMessageStore.createNotificationMessage(values)
        : notificationMessageStore.updateNotificationMessage(
            data.value.row.id,
            values,
          ));
