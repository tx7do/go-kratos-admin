...
func RegisterPositionServiceHTTPServer(s *http.Server, srv PositionServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/admin/v1/positions", _PositionService_List10_HTTP_Handler(srv))
	r.GET("/admin/v1/positions/{id}", _PositionService_Get10_HTTP_Handler(srv))
	r.POST("/admin/v1/positions", _PositionService_Create8_HTTP_Handler(srv))
	r.PUT("/admin/v1/positions/{data.id}", _PositionService_Update8_HTTP_Handler(srv))
	r.DELETE("/admin/v1/positions/{id}", _PositionService_Delete8_HTTP_Handler(srv))
}

func _PositionService_List10_HTTP_Handler(srv PositionServiceHTTPServer) func(ctx http.Context) error {
...
func _PositionService_Get10_HTTP_Handler(srv PositionServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
