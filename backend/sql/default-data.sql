...
INSERT INTO public.sys_api_resources (id, created_at, updated_at, deleted_at, created_by, updated_by, description, module, module_description, operation, path, method, scope) VALUES
      ...
      (9, now(), null, null, null, null, '删除后台登录限制', 'AdminLoginRestrictionService', '后台登录限制管理服务', 'AdminLoginRestrictionService_Delete', '/admin/v1/login-restrictions/{id}', 'DELETE', 'ADMIN'),
      (10, now(), null, null, null, null, '获取租户列表', 'TenantService', '租户管理服务', 'TenantService_List', '/admin/v1/tenants', 'GET', 'ADMIN'),
      (11, now(), null, null, null, null, '创建租户', 'TenantService', '租户管理服务', 'TenantService_Create', '/admin/v1/tenants', 'POST', 'ADMIN'),
      (12, now(), null, null, null, null, '获取对象存储（OSS）上传用的预签名链接', 'OssService', 'OSS服务', 'OssService_OssUploadUrl', '/admin/v1/file:upload-url', 'POST', 'ADMIN'),
      (13, now(), null, null, null, null, '删除API资源', 'ApiResourceService', 'API资源管理服务', 'ApiResourceService_Delete', '/admin/v1/api-resources/{id}', 'DELETE', 'ADMIN'),
      (14, now(), null, null, null, null, '查询API资源详情', 'ApiResourceService', 'API资源管理服务', 'ApiResourceService_Get', '/admin/v1/api-resources/{id}', 'GET', 'ADMIN'),
      (15, now(), null, null, null, null, '删除租户', 'TenantService', '租户管理服务', 'TenantService_Delete', '/admin/v1/tenants/{id}', 'DELETE', 'ADMIN'),
      (16, now(), null, null, null, null, '获取租户数据', 'TenantService', '租户管理服务', 'TenantService_Get', '/admin/v1/tenants/{id}', 'GET', 'ADMIN'),
      (17, now(), null, null, null, null, '删除职位', 'PositionService', '职位管理服务', 'PositionService_Delete', '/admin/v1/positions/{id}', 'DELETE', 'ADMIN'),
      (18, now(), null, null, null, null, '查询职位详情', 'PositionService', '职位管理服务', 'PositionService_Get', '/admin/v1/positions/{id}', 'GET', 'ADMIN'),
      (19, now(), null, null, null, null, '更新通知消息接收者', 'NotificationMessageRecipientService', '通知消息接收者管理服务', 'NotificationMessageRecipientService_Update', '/admin/v1/notifications:recipients/{data.id}', 'PUT', 'ADMIN'),
      (20, now(), null, null, null, null, '登出', 'AuthenticationService', '用户后台登录认证服务', 'AuthenticationService_Logout', '/admin/v1/logout', 'POST', 'ADMIN'),
      (21, now(), null, null, null, null, '更新通知消息分类', 'NotificationMessageCategoryService', '通知消息分类管理服务', 'NotificationMessageCategoryService_Update', '/admin/v1/notifications:categories/{data.id}', 'PUT', 'ADMIN'),
      (22, now(), null, null, null, null, '控制调度任务', 'TaskService', '调度任务管理服务', 'TaskService_ControlTask', '/admin/v1/tasks:control', 'POST', 'ADMIN'),
      (23, now(), null, null, null, null, '更新调度任务', 'TaskService', '调度任务管理服务', 'TaskService_Update', '/admin/v1/tasks/{data.id}', 'PUT', 'ADMIN'),
      (24, now(), null, null, null, null, '查询API资源列表', 'ApiResourceService', 'API资源管理服务', 'ApiResourceService_List', '/admin/v1/api-resources', 'GET', 'ADMIN'),
      (25, now(), null, null, null, null, '创建API资源', 'ApiResourceService', 'API资源管理服务', 'ApiResourceService_Create', '/admin/v1/api-resources', 'POST', 'ADMIN'),
      (26, now(), null, null, null, null, '查询后台登录日志详情', 'AdminLoginLogService', '后台登录日志管理服务', 'AdminLoginLogService_Get', '/admin/v1/admin_login_logs/{id}', 'GET', 'ADMIN'),
      (27, now(), null, null, null, null, '停止所有的调度任务', 'TaskService', '调度任务管理服务', 'TaskService_StopAllTask', '/admin/v1/tasks:stop', 'POST', 'ADMIN'),
      (28, now(), null, null, null, null, '删除角色', 'RoleService', '角色管理服务', 'RoleService_Delete', '/admin/v1/roles/{id}', 'DELETE', 'ADMIN'),
      (29, now(), null, null, null, null, '查询角色详情', 'RoleService', '角色管理服务', 'RoleService_Get', '/admin/v1/roles/{id}', 'GET', 'ADMIN'),
      (30, now(), null, null, null, null, '删除通知消息', 'NotificationMessageService', '通知消息管理服务', 'NotificationMessageService_Delete', '/admin/v1/notifications/{id}', 'DELETE', 'ADMIN'),
      (31, now(), null, null, null, null, '查询通知消息详情', 'NotificationMessageService', '通知消息管理服务', 'NotificationMessageService_Get', '/admin/v1/notifications/{id}', 'GET', 'ADMIN'),
      (32, now(), null, null, null, null, '创建租户及管理员用户', 'TenantService', '租户管理服务', 'TenantService_CreateTenantWithAdminUser', '/admin/v1/tenants_with_admin', 'POST', 'ADMIN'),
      (33, now(), null, null, null, null, '更新通知消息', 'NotificationMessageService', '通知消息管理服务', 'NotificationMessageService_Update', '/admin/v1/notifications/{data.id}', 'PUT', 'ADMIN'),
      (34, now(), null, null, null, null, '登录', 'AuthenticationService', '用户后台登录认证服务', 'AuthenticationService_Login', '/admin/v1/login', 'POST', 'ADMIN'),
      (35, now(), null, null, null, null, '删除私信消息', 'PrivateMessageService', '私信消息管理服务', 'PrivateMessageService_Delete', '/admin/v1/private_messages/{id}', 'DELETE', 'ADMIN'),
      (36, now(), null, null, null, null, '查询私信消息详情', 'PrivateMessageService', '私信消息管理服务', 'PrivateMessageService_Get', '/admin/v1/private_messages/{id}', 'GET', 'ADMIN'),
      (37, now(), null, null, null, null, '查询通知消息分类列表', 'NotificationMessageCategoryService', '通知消息分类管理服务', 'NotificationMessageCategoryService_List', '/admin/v1/notifications:categories', 'GET', 'ADMIN'),
      (38, now(), null, null, null, null, '创建通知消息分类', 'NotificationMessageCategoryService', '通知消息分类管理服务', 'NotificationMessageCategoryService_Create', '/admin/v1/notifications:categories', 'POST', 'ADMIN'),
      (39, now(), null, null, null, null, '查询后台登录限制列表', 'AdminLoginRestrictionService', '后台登录限制管理服务', 'AdminLoginRestrictionService_List', '/admin/v1/login-restrictions', 'GET', 'ADMIN'),
      ...
      (48, now(), null, null, null, null, '删除通知消息分类', 'NotificationMessageCategoryService', '通知消息分类管理服务', 'NotificationMessageCategoryService_Delete', '/admin/v1/notifications:categories/{id}', 'DELETE', 'ADMIN'),
      (49, now(), null, null, null, null, '查询通知消息分类详情', 'NotificationMessageCategoryService', '通知消息分类管理服务', 'NotificationMessageCategoryService_Get', '/admin/v1/notifications:categories/{id}', 'GET', 'ADMIN'),
      (50, now(), null, null, null, null, '查询组织列表', 'OrganizationService', '组织管理服务', 'OrganizationService_List', '/admin/v1/organizations', 'GET', 'ADMIN'),
      (51, now(), null, null, null, null, '创建组织', 'OrganizationService', '组织管理服务', 'OrganizationService_Create', '/admin/v1/organizations', 'POST', 'ADMIN'),
      (52, now(), null, null, null, null, '查询调度任务列表', 'TaskService', '调度任务管理服务', 'TaskService_List', '/admin/v1/tasks', 'GET', 'ADMIN'),
      (53, now(), null, null, null, null, '创建调度任务', 'TaskService', '调度任务管理服务', 'TaskService_Create', '/admin/v1/tasks', 'POST', 'ADMIN'),
      (54, now(), null, null, null, null, '查询路由列表', 'RouterService', '网站后台动态路由服务', 'RouterService_ListRoute', '/admin/v1/routes', 'GET', 'ADMIN'),
      (55, now(), null, null, null, null, '查询后台登录日志列表', 'AdminLoginLogService', '后台登录日志管理服务', 'AdminLoginLogService_List', '/admin/v1/admin_login_logs', 'GET', 'ADMIN'),
      (56, now(), null, null, null, null, '任务类型名称列表', 'TaskService', '调度任务管理服务', 'TaskService_ListTaskTypeName', '/admin/v1/tasks:type-names', 'GET', 'ADMIN'),
      ...
      (66, now(), null, null, null, null, '创建通知消息', 'NotificationMessageService', '通知消息管理服务', 'NotificationMessageService_Create', '/admin/v1/notifications', 'POST', 'ADMIN'),
      (67, now(), null, null, null, null, '获取用户列表', 'UserService', '用户管理服务', 'UserService_List', '/admin/v1/users', 'GET', 'ADMIN'),
      (68, now(), null, null, null, null, '创建用户', 'UserService', '用户管理服务', 'UserService_Create', '/admin/v1/users', 'POST', 'ADMIN'),
      (69, now(), null, null, null, null, '用户是否存在', 'UserService', '用户管理服务', 'UserService_UserExists', '/admin/v1/users_exists', 'GET', 'ADMIN'),
      (70, now(), null, null, null, null, 'UEditor API', 'UEditorService', 'UEditor后端服务', 'UEditorService_UEditorAPI', '/admin/v1/ueditor', 'GET', 'ADMIN'),
      (71, now(), null, null, null, null, '上传文件', 'UEditorService', 'UEditor后端服务', 'UEditorService_UploadFile', '/admin/v1/ueditor', 'POST', 'ADMIN'),
      (72, now(), null, null, null, null, '查询职位列表', 'PositionService', '职位管理服务', 'PositionService_List', '/admin/v1/positions', 'GET', 'ADMIN'),
      (73, now(), null, null, null, null, '创建职位', 'PositionService', '职位管理服务', 'PositionService_Create', '/admin/v1/positions', 'POST', 'ADMIN'),
      (74, now(), null, null, null, null, '更新菜单', 'MenuService', '后台菜单管理服务', 'MenuService_Update', '/admin/v1/menus/{data.id}', 'PUT', 'ADMIN'),
      (75, now(), null, null, null, null, '更新职位', 'PositionService', '职位管理服务', 'PositionService_Update', '/admin/v1/positions/{data.id}', 'PUT', 'ADMIN'),
      (76, now(), null, null, null, null, '查询路由数据', 'ApiResourceService', 'API资源管理服务', 'ApiResourceService_GetWalkRouteData', '/admin/v1/api-resources/walk-route', 'GET', 'ADMIN'),
      (77, now(), null, null, null, null, '删除通知消息接收者', 'NotificationMessageRecipientService', '通知消息接收者管理服务', 'NotificationMessageRecipientService_Delete', '/admin/v1/notifications:recipients/{id}', 'DELETE', 'ADMIN'),
      (78, now(), null, null, null, null, '查询通知消息接收者详情', 'NotificationMessageRecipientService', '通知消息接收者管理服务', 'NotificationMessageRecipientService_Get', '/admin/v1/notifications:recipients/{id}', 'GET', 'ADMIN'),
      (79, now(), null, null, null, null, '更新API资源', 'ApiResourceService', 'API资源管理服务', 'ApiResourceService_Update', '/admin/v1/api-resources/{data.id}', 'PUT', 'ADMIN'),
      (80, now(), null, null, null, null, '查询权限码列表', 'RouterService', '网站后台动态路由服务', 'RouterService_ListPermissionCode', '/admin/v1/perm-codes', 'GET', 'ADMIN'),
      (81, now(), null, null, null, null, '同步API资源', 'ApiResourceService', 'API资源管理服务', 'ApiResourceService_SyncApiResources', '/admin/v1/api-resources/sync', 'POST', 'ADMIN'),
      (82, now(), null, null, null, null, '更新用户', 'UserService', '用户管理服务', 'UserService_Update', '/admin/v1/users/{data.id}', 'PUT', 'ADMIN'),
      (83, now(), null, null, null, null, '删除组织', 'OrganizationService', '组织管理服务', 'OrganizationService_Delete', '/admin/v1/organizations/{id}', 'DELETE', 'ADMIN'),
      (84, now(), null, null, null, null, '查询组织详情', 'OrganizationService', '组织管理服务', 'OrganizationService_Get', '/admin/v1/organizations/{id}', 'GET', 'ADMIN'),
      (85, now(), null, null, null, null, '查询部门列表', 'DepartmentService', '部门管理服务', 'DepartmentService_List', '/admin/v1/departments', 'GET', 'ADMIN'),
      (86, now(), null, null, null, null, '创建部门', 'DepartmentService', '部门管理服务', 'DepartmentService_Create', '/admin/v1/departments', 'POST', 'ADMIN'),
      (87, now(), null, null, null, null, '查询菜单列表', 'MenuService', '后台菜单管理服务', 'MenuService_List', '/admin/v1/menus', 'GET', 'ADMIN'),
      (88, now(), null, null, null, null, '创建菜单', 'MenuService', '后台菜单管理服务', 'MenuService_Create', '/admin/v1/menus', 'POST', 'ADMIN'),
      ...
      (99, now(), null, null, null, null, '更新部门', 'DepartmentService', '部门管理服务', 'DepartmentService_Update', '/admin/v1/departments/{data.id}', 'PUT', 'ADMIN'),
      (100, now(), null, null, null, null, '查询角色列表', 'RoleService', '角色管理服务', 'RoleService_List', '/admin/v1/roles', 'GET', 'ADMIN'),
      (101, now(), null, null, null, null, '创建角色', 'RoleService', '角色管理服务', 'RoleService_Create', '/admin/v1/roles', 'POST', 'ADMIN'),
      (102, now(), null, null, null, null, '更新文件', 'FileService', '文件管理服务', 'FileService_Update', '/admin/v1/files/{data.id}', 'PUT', 'ADMIN'),
      (103, now(), null, null, null, null, '更新私信消息', 'PrivateMessageService', '私信消息管理服务', 'PrivateMessageService_Update', '/admin/v1/private_messages/{data.id}', 'PUT', 'ADMIN'),
      (104, now(), null, null, null, null, '删除调度任务', 'TaskService', '调度任务管理服务', 'TaskService_Delete', '/admin/v1/tasks/{id}', 'DELETE', 'ADMIN'),
      (105, now(), null, null, null, null, '查询调度任务详情', 'TaskService', '调度任务管理服务', 'TaskService_Get', '/admin/v1/tasks/{id}', 'GET', 'ADMIN'),
      (106, now(), null, null, null, null, '删除部门', 'DepartmentService', '部门管理服务', 'DepartmentService_Delete', '/admin/v1/departments/{id}', 'DELETE', 'ADMIN'),
      (107, now(), null, null, null, null, '查询部门详情', 'DepartmentService', '部门管理服务', 'DepartmentService_Get', '/admin/v1/departments/{id}', 'GET', 'ADMIN'),
      (108, now(), null, null, null, null, '更新后台登录限制', 'AdminLoginRestrictionService', '后台登录限制管理服务', 'AdminLoginRestrictionService_Update', '/admin/v1/login-restrictions/{data.id}', 'PUT', 'ADMIN'),
      (109, now(), null, null, null, null, '刷新认证令牌', 'AuthenticationService', '用户后台登录认证服务', 'AuthenticationService_RefreshToken', '/admin/v1/refresh_token', 'POST', 'ADMIN'),
      (110, now(), null, null, null, null, '租户是否存在', 'TenantService', '租户管理服务', 'TenantService_TenantExists', '/admin/v1/tenants_exists', 'GET', 'ADMIN'),
      (111, now(), null, null, null, null, '查询后台操作日志列表', 'AdminOperationLogService', '后台操作日志管理服务', 'AdminOperationLogService_List', '/admin/v1/admin_operation_logs', 'GET', 'ADMIN'),
      (112, now(), null, null, null, null, '删除菜单', 'MenuService', '后台菜单管理服务', 'MenuService_Delete', '/admin/v1/menus/{id}', 'DELETE', 'ADMIN'),
      (113, now(), null, null, null, null, '查询菜单详情', 'MenuService', '后台菜单管理服务', 'MenuService_Get', '/admin/v1/menus/{id}', 'GET', 'ADMIN')
;
