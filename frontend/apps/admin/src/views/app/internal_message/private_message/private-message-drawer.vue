...
import { statusList, usePrivateMessageStore } from '#/stores';
  ...
  async onConfirm() {
    ...
    try {
      await (data.value?.create
        ? privateMessageStore.createPrivateMessage(values)
        : privateMessageStore.updatePrivateMessage(data.value.row.id, values));
